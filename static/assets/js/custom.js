(() => {
  ...
  !(function (o) {
    ...
    o('[data-toggle="tooltip"]').tooltip(),
      ...
      o(document).on("click", '[data-toggle="card-remove"]', function (e) {
        return o(this).closest(t).remove(), e.preventDefault(), !1;
      }),
      o(document).on("click", '[data-toggle="card-collapse"]', function (e) {
        return (
      ...
      o(document).on("click", '[data-toggle="card-fullscreen"]', function (e) {
        return (
          o(this)
            .closest(t)
