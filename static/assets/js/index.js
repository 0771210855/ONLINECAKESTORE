  ...
  c3.generate({
    ...
    c3.generate({
      ...
      data: {
        ...
        classes: { data1: "filled", data2: "filled", data3: "filled" },
        type: "area-spline",
        groups: [["data1", "data2", "data3"]],
        colors: { data1: "#0774f8", data2: "#d43f8d ", data3: "#09ad95" },
    ...
    c3.generate({
      ...
      data: {
        ...
        type: "donut",
        colors: { data1: "#6574cd", data2: "#2bcbba", data3: "#f66d9b" },
    ...
    c3.generate({
      ...
      data: {
        ...
        type: "pie",
        colors: { data1: "#ffcc29", data2: "#17a2b8", data3: "#ff7088" },
        names: { data1: "profit1", data2: "profit2", data3: "profit3" },
      },
      axis: {},
      legend: { show: !0 },
      padding: { bottom: 0, top: 0 },
    ...
    c3.generate({
      ...
      data: {
        type: "donut",
        names: { data1: "Open", data2: "Bounce", data3: "Unsubscribe" },
        columns: [
          ["data1", 30],
          ["data2", 50],
          ["data3", 25],
    ...
    t(".resp-tabs-list .home-hogo").addClass("active"),
    t(".second-sidemenu .home-hogo").addClass("resp-tab-content-active");
})(jQuery);
